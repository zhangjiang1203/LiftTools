...
- (LEEConfigToString)LeeContent{
    ...
    return ^(NSString *str){
        ...
        return  weakSelf.LeeAddContent(^(UILabel *label) {
            ...
            NSDictionary *attributes = @{ NSFontAttributeName:[UIFont systemFontOfSize:14], NSParagraphStyleAttributeName:paragraphStyle,NSForegroundColorAttributeName:[UIColor blackColor]};//字体大小 行间距  颜色
